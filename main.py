...
TOKEN = "MTUxMDgwMTI5NjYxMjEzMDg2Ng.GgZ1hS.gBB8eSDMAhTD2V7uoBSurtkIn2lSTa9aS5MCbI"
GUILD_ID = 1495226742124843048  # Guild ID where command registers
# Add as many staff role IDs as you want here:
STAFF_ROLE_IDS = [1497021905536811058, 1495226875482734614, 1495240020720615655, 1495493248259719321, 1496636262642352250, 1497012056384077895 ]  # example: [role_id1, role_id2, ...]
...
def menu_embed():
    e = discord.Embed(title="Ticket Panel", color=discord.Color.blurple())
    e.description = (
        "A ticket will give you access to contact the staff team for reports and support. They will be able to help you with anything related to the game or the server. This is a way to get help from the .\n"
        "staff team without being in a channel where they are active. \n"
        "**Report A Player**\nReport a player for breaking the rules.\n"
        "**General Support**\nGet help with general questions or issues.\n"
        "**Ranked Support**\nGet help with ranked related questions or issues.\n"
    )
    return e
...
class TicketMenuView(discord.ui.View):
    ...
    @discord.ui.button(label="Ranked Support", style=discord.ButtonStyle.success, custom_id="ticket_ranked")
    async def ranked(self, interaction: discord.Interaction, button: discord.ui.Button):
        await create_ticket_channel(interaction, "Ranked Support", self.category_id)
